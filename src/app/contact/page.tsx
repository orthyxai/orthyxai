            ...
            <div className="space-y-10">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <a href="mailto:hello@orthyxai.io" className="text-primary font-bold text-lg hover:underline">hello@orthyxai.io</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <a href="https://github.com/orthyxai" className="text-primary font-bold text-lg hover:underline">github.com/orthyxai</a>
                </div>
              </div>
