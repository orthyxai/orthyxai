...
export default function Home() {
  ...
  const stats = [
    ...
    { value: "99.9%", label: "Alignment Score" },
    { value: "100+", label: "Models" },
    { value: "<10ms", label: "Override Latency" },
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <AnimatedSection className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight mb-8 text-gray-900 leading-tight">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-teal-500 to-emerald-300 animate-gradient-shift">
                  {t.hero.title}
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <motion.a href="https://github.com/orthyxai" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                  <Button variant="contained" size="large" endIcon={<ArrowRight />} sx={{ px: 4, py: 2, fontSize: "1.1rem", boxShadow: "0 8px 32px #14B8A640" }}>
                    {t.hero.cta_github}
                  </Button>
                </motion.a>
            ...
            <AnimatedSection delay={0.2} className="flex-1 w-full max-w-2xl">
              <motion.div className="relative" whileHover={{ scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }}>
                ...
                <img src="/images/hero.jpg" alt={t.hero.title} className="relative rounded-[2rem] shadow-2xl border border-gray-200 w-full object-cover aspect-[4/3]" />
              </motion.div>
            </AnimatedSection>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {stats.map((s, i) => (
              <AnimatedSection key={i} delay={i * 0.1}>
                <motion.div whileHover={{ scale: 1.1 }} className="p-6 rounded-2xl bg-white/80 backdrop-blur-md border-gray-200 border">
      ...
      <section className="py-24 bg-gray-50/50">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl font-bold mb-6 text-gray-900">Safety by Design</h2>
            <p className="text-xl text-gray-600">Orthogonal decomposition and interpretable control layers that keep humans in the loop.</p>
          </AnimatedSection>
            ...
            {features.map((f, i) => (
              <AnimatedSection key={i} delay={0.1 + i * 0.1}>
                <motion.div whileHover={{ y: -8, boxShadow: `0 20px 60px -10px X` }} transition={{ type: "spring", stiffness: 300 }}
                  className="bg-white/80 backdrop-blur-md p-10 rounded-3xl shadow-sm border-gray-200 border hover:border-primary/30 transition-all group">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <AnimatedSection className="flex-1 w-full max-w-2xl order-2 lg:order-1">
              <motion.div className="relative" whileHover={{ scale: 1.02 }}>
                <div className="absolute -inset-4 bg-primary/20 rounded-[2.5rem] blur-2xl opacity-50 animate-pulse-glow"></div>
                <img src="/images/feature.jpg" alt="Feature preview" className="relative rounded-[2rem] shadow-2xl border border-gray-200 w-full object-cover aspect-[4/3]" />
              </motion.div>
            </AnimatedSection>
            <AnimatedSection delay={0.2} className="flex-1 text-center lg:text-left order-1 lg:order-2">
              ...
              <h2 className="text-4xl font-bold mb-6 text-gray-900">Precision Alignment Through Orthogonality</h2>
              <p className="text-xl text-gray-600 leading-relaxed">orthyx AI researches orthogonal decomposition methods for safer artificial intelligence. Our alignment sandbox lets researchers stress-test models against edge cases and distribution shifts before deployment.</p>
            </AnimatedSection>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gray-50/50">
        <div className="container mx-auto px-4 text-center">
          <AnimatedSection className="max-w-3xl mx-auto">
            <h2 className="text-4xl lg:text-5xl font-extrabold mb-6 text-gray-900">Build AI You Can Trust</h2>
            <p className="text-xl text-gray-600 mb-10">Join researchers making AI safer through orthogonal decomposition and rigorous testing.</p>
            <motion.a href="https://github.com/orthyxai" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
