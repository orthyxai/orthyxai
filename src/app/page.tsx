    ...
    <div>
      <section className="hero">
        <div className="container">
          <h1 className="hero-title">Orthyx AI</h1>
          <p className="hero-subtitle">
            Intelligent automation and robotic process optimization.
          </p>
          <div className="hero-actions">
            <Link href="https://github.com/orthyxai" className="btn btn-primary">
              View on GitHub
            </Link>
          </div>
        </div>
          ...
          <div className="grid">
            <div className="card">
              ...
              <p className="card-desc">
                Foundational tools and libraries that power the orthyxai ecosystem.
              </p>
            </div>
            <div className="card">
